...
while (restartGame) {
    ...
    // Verifying the user's entery for a number of attempts allowed is a number greater than zero and euqal to or less than the range they set
    ...
    // Continues looping until the user guesses the corect number or runs out of attempts (NOTE: Loops until a BREAK keyword is run)
    while (true) {
